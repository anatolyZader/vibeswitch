...
class IVSCodePort {
    ...
    /**
     * Show a QuickPick dialog
     * @param {Array} items - Array of items to display
     * @param {Object} options - QuickPick options
     * @returns {Promise<Object|undefined>} Selected item or undefined
     */
     ...
     * @param {Object} document - TextDocument instance
     * @param {Object} options - Show options
     * @returns {Promise<Object>} TextEditor instance
     */
    showTextDocument(document, options) {
        throw new Error('showTextDocument not implemented');
    }
}
