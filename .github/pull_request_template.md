...
- [ ] cross_cut_modules (cross-cutting/AOP-style)
- [ ] infra / CI / tooling
- [ ] docs

## Boundaries & Architecture (required)
- **Touched modules:** <!-- list paths, e.g. business_modules/awareness, cross_cut_modules/auth -->
...
## Agent metadata (required for agent PRs)
- Agent name: <!-- e.g. architector / qa / security -->
- Mode: <!-- DEV | VIBE -->
